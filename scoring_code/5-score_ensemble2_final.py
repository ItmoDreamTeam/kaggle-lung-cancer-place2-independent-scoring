...
INPUT_BASE_PATH = configuration.TMP_DIR + '/v1_nodules'
...
if __name__ == '__main__':
    ...
    # load the models
    if True:
        model37g = "ensemble 2 models/model_des_v37g_64_finetune_04.h5"
        print '37g'
        model37b = "ensemble 2 models/model_des_v37b_mse_64_finetune_04.h5"
        print 'loaded 37b'
        model37d = "ensemble 2 models/model_des_v37d_64_finetune_04.h5"
        print '37d'
        model37f = "ensemble 2 models/model_des_v37f_64_finetune_04.h5"
        print '37f'
        model38 = "ensemble 2 models/model_des_v38_mse_64_finetune_04.h5"
        print '38'
        # from local
        model37 = "ensemble 2 models/model_des_v37_mse_64_finetune_04.h5"
        print '37'
        model37c = "ensemble 2 models/model_des_v37c_64_finetune_04.h5"
        print '37c'
        ...
        print '37c'
        models = ['ensemble 2 models/model_des_v37c_64_finetune_04.h5']  # model37c, model37c]
        names = ['test1']  # , 'test2']
