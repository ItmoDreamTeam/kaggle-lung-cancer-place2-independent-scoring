...
INPUT_BASE_PATH = configuration.TMP_DIR + '/v29_nodules'
DATA_DIR = configuration.TMP_DIR + '/dataset_1mm'
...
model34 = load_model("ensemble 1 models/model_LUNA_64_v34_describer_24.h5",
                     custom_objects={'looks_linear_init': looks_linear_init})
model_multi_relu = load_model("ensemble 1 models/model_des_v35_multi_64_24.h5")
model34_repl = load_model("ensemble 1 models/model_des_v34_repl_64_24.h5")
model35_relu = load_model("ensemble 1 models/model_des_v35_relu_64_24_multiout.h5")
model_v36_mse_ft = load_model("ensemble 1 models/model_des_v36_mse_64_finetune_02.h5")
# model_v36_mse = load_model(r"F:\Flung\descriptor models\model_des_v36_mse_64_24.h5")
model_v29 = load_model(r"ensemble 1 models/model_LUNA_64_v29_14.h5")

# model_relu = load_model(r"F:\Flung\descriptor models\malig_only_v35_relu_b32.")
model_sigmoid = load_model(r"ensemble 1 models/model_des_v35_sigmoid_64_24.h5")
model_relu_s2 = load_model(r"ensemble 1 models/model_des_v35_relu_s2_64_24.h5")
